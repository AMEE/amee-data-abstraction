module AMEE
  module DataAbstraction
    module Exceptions
      ...
      # Throw this exception when user specifies a suggested UI for a term which is not supported.
      class InvalidInterface < Exception ; end
      # Throw this exception when user tries to set a value for a term with a read-only value.
      class FixedValueInterference < Exception; end
      # Throw this exception when someone tries to access a term which is not defined for a calculation.
      class NoSuchTerm < Exception; end
      # Throw this exception when trying to create a PI for a calculation which already has a corresponding PI.
      class AlreadyHaveProfileItem < Exception; end
      # Throw this exception when a locally stored calculation and the information on the AMEE server have got out of sync.
      ...
      # Throw this exception when someone tries to specify a "usage" twice when definining a PrototypeCalculation using the DSL.
